...
if __name__ == "__main__":
    ...
    output_folder=r"C:\Users\yatha\OneDrive\Pictures\Camera Roll\check"
    mp_hands = mp.solutions.hands
    mp_drawing = mp.solutions.drawing_utils

    base_options = python.BaseOptions(model_asset_path='hand_landmarker.task')
    options = vision.HandLandmarkerOptions(base_options=base_options, min_hand_detection_confidence=0.1, running_mode=VisionRunningMode.IMAGE,
        ...
        if key == 27:  # ESC key
            ...
            while capturing_frame:
                ...
                if elapsed_time >= 5:  # If 5 seconds have passed
                    ...
                    image_filename = os.path.join(output_folder, f"captured_frame_{time.time()}.png")
                    ...
                    if results.hand_landmarks is not None:
                        ...
                        if preprocessed_landmarks is not None:
                            ...
                            cv2.putText(frame, current_output, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
                            cv2.imshow('Processed Frame', frame)
                        else :
                            print("No hands ")

                            # Remove the captured frame from display
