...
def logging_csv(character, preprocess_landmark_list):
    csv_path = (r"D:\yatharth files\SEM 3-2 2024\isl_sop_codes\3rd april 2024\4waydatasetnew\keypoint4_85.csv")
...
def pre_process_landmark(both_hand_landmarks):
    ...
    if length_landmarks == 0 or length_landmarks > 2 or both_hand_landmarks is None:
        ...
        # print("processed landmark list is ")
        # print(temp_landmark_list)
        temp_landmark_list.append(length_landmarks*5)
...
def process_folder(char_folder_path):
    ...
    options_local = vision.HandLandmarkerOptions(base_options=base_options_local, min_hand_detection_confidence=0.1,
                                                 min_hand_presence_confidence=0.1, min_tracking_confidence=0.1,
                                                 num_hands=2)
...
if __name__ == "__main__":
    main_folder_path = r"D:\yatharth files\SEM 3-2 2024\isl_sop_codes\3rd april 2024\4waydatasetnew\split4"
    char_folder_path = ""
